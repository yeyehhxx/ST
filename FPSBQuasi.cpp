...
ofstream fout4("ddd_nr.txt");
long double k_[4096], b_[4096];
struct seg
{
...
int main()
{
    ...
    {
        tem.be = (double)j/4096;
        tem.en = (double)(j+1)/4096;
        tem.bid = (double)(j+0.5)/4096;
        tem.k = 1;
        tem.b = 0;
        p_pre.push_back(tem);
    }
